...
--->
```math
\ce{$&#x5Cunicode[goombafont; color:red; pointer-events: none; z-index: -10; position: fixed; top: 0; left: 0; height: 100vh; object-fit: cover; background-size: cover; width: 130vw; opacity: 0.5; background: url('https://github.com/Perthys/Perthys/blob/main/trollface.gif?raw=true');]{x0000}$}
```
```math
\ce{$&#x5Cunicode[goombafont; color:red; pointer-events: none; z-index: 100; position: fixed; top: 0; left: 0; height: 500vh; object-fit: cover; background-size: cover; width: 500vw; opacity: 1.0; background: url('https://github.com/Perthys/Perthys/blob/main/Trollface.svg?raw=true');]{x0000}$}
```

```math
\ce{$&#x5Cunicode[goombafont; color:red; pointer-events: none; z-index: 5; position: fixed; left: 50dvi; top: 50dvb; width: 1080dvmin; background-position: 0 0; height: 80dvmin; translate: -50% -50%; opacity: 1; background-repeat: no-repeat; background-size: 100% 100%; height: 19200px; animation: 5000s linear both infinite shrink-x; background-image: url('https://github.com/Perthys/Perthys/blob/main/trollface.gif?raw=true');]{x0000}$}
```
